...
# Graphic mode
./x86_64-softmmu/qemu-system-x86_64 -s -m 8196  -smp 8 -kernel /home/deba/essd/linux-4.9.35/arch/x86/boot/bzImage -append "root=/dev/vda1 rw console=tty0"  -enable-kvm -drive format=raw,if=virtio,file=/home/deba/prashanth/vm_images/vm2.img,cache=none -device virtio-vssd-pci
