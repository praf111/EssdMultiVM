...
# Graphic mode
./x86_64-softmmu/qemu-system-x86_64 -kernel /home/deba/essd/linux-4.9.352/arch/x86/boot/bzImage -append "root=/dev/vda1 rw console=tty1"  -enable-kvm -drive format=raw,if=virtio,file=/home/deba/essd/vm2.img,cache=none -netdev bridge,br=virbr0,helper=./qemu-bridge-helper,id=myeth0 -device virtio-net-pci,netdev=myeth0 -device virtio-vssd-pci
