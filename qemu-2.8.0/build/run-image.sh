...
# Graphic moide
./x86_64-softmmu/qemu-system-x86_64 -name VM1 -drive file=/home/deba/Desktop/demo_x64.qcow2  -kernel /home/deba/essd/linux-4.9.35/arch/x86/boot/bzImage -append "root=/dev/sda1 rw console=tty0" -netdev bridge,br=virbr0,helper=./qemu-bridge-helper,id=myeth0  -device virtio-net-pci,netdev=myeth0 -device virtio-vssd-pci -enable-kvm
